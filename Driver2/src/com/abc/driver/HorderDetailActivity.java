...
public class HorderDetailActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		IS_DRIVER_REPLIED = intent.getIntExtra(
				CellSiteConstants.IS_DRIVER_REPLIED, 0);
	...
	public void initView(Intent intent) {
		...
		if (IS_DRIVER_REPLIED == 1) {
			mReqHorderBtn.setText(res.getString(R.string.already_requested));
		} else {
			mReqHorderBtn.setText(res.getString(R.string.request_horder));
		}
	...
	private class ReqHorderTask extends AsyncTask<String, String, Integer> {
		...
		public void onPostExecute(Integer result) {
			...
			if (CellSiteConstants.RESULT_SUC == result) {
				...
				IS_DRIVER_REPLIED = 1; // TODO: 将更新状态返回

			} else if (CellSiteConstants.RESULT_REMOVE == result) {
				mReqHorderBtn.setText(res.getText(R.string.request_horder));
				mReqHorderBtn.setBackgroundColor(111); // TODO: 添加disable 状态
				IS_DRIVER_REPLIED = 0; // T
